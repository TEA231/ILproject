...
class Ui_ResultWindow(object):
    def setupUi(self, ResultWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 210, 261, 21))
        self.label_2.setStyleSheet("background: transparent;\n"
                                   "color: white;\n"
                                   "border: none;")
        self.label_2.setObjectName("label_2")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(40, 130, 261, 21))
        self.label_4.setStyleSheet("background: transparent;\n"
                                   "color: white;\n"
                                   "border: none;")
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(40, 90, 261, 21))
        self.label_5.setStyleSheet("background: transparent;\n"
                                   "color: white;\n"
                                   "border: none;")
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(40, 170, 261, 21))
